...
tf.flags.DEFINE_string("pre_trained_Word2vector", "/home/nzhang/embed/head.txt", "Data source for Word2vector.")
...
tf.flags.DEFINE_string("sql_train", "select title, keywords, description, corpus ,label from p2p_df where  class= 'trainset' limit 100", "SQL querys trainset")
tf.flags.DEFINE_string("sql_test", " select title, keywords, description, corpus ,label from p2p_df where  class= 'testset' limit 10", "SQL querys trainset")
